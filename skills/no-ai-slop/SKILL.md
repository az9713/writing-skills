...
- **Over-tidying every paragraph** — don't make every paragraph equally polished or rewrite distinctive lines merely for consistency.
- **Inventing claims, examples, stats, or opinions the draft doesn't have** — ask the user instead when something is unclear.
- **Letting inanimate things do human verbs** — never write "the decision emerged"; use active voice like "the team shipped it."
- **Scoring or guessing whether AI wrote a draft during a detect request** — don't; name patterns and quote the line instead.
- **Rewriting a fake-profound kicker into a better metaphor** — don't; delete it and end on the clearest concrete sentence instead.
